# Goal: Do a summary stat of GTEx v10 bladder tissue FGFR3 isoform TPM 
...
# Thanks Oscar's script, modified the code accordingly to fix the data
...
df_stats.tpm <- tmp.i_tpm[, 2:ncol(tmp.i_tpm)] %>%
  rowwise() %>%
  mutate(
